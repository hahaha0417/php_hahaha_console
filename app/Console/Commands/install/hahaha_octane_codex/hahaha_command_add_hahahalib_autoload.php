...
class hahaha_command_add_hahahalib_autoload extends Command
{
    protected $signature = 'hahaha:install:hahaha_octane_codex:composer:add_hahahalib_autoload {project_path_}';

    protected $description = 'Add the Hahahalib classmap autoload mapping and run composer dump-autoload';
    ...
    public function handle(): int
    {
        ...
        if (! isset($composer_config_['autoload']['classmap']) || ! is_array($composer_config_['autoload']['classmap'])) {
            $composer_config_['autoload']['classmap'] = [];
        }

        $composer_config_['autoload']['classmap'] = array_values(array_unique([
            ...$composer_config_['autoload']['classmap'],
            'library/hahahalib',
        ]));
