...
{
    protected $signature = 'hahaha:install:hahaha_octane_codex:git:clone_hahahalib {target_path_}';

    protected $description = 'Clone the php_hahahalib repository into the specified directory';
